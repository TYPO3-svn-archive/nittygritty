    ...
    $.fn.socialSharePrivacy = function (settings) {
        var defaults = {
            'services' : {
                ...
                'xing' : {
                    ...
                    'txt_gplus_on'      : 'mit Xing verbunden',
                    'perma_option'      : 'on',
                    'display_name'      : 'Xing',
                    'referrer_track'    : '',
                    'language'          : 'de'
            ...
            'txt_help'          : 'Wenn Sie diese Felder durch einen Klick aktivieren, werden Informationen an Facebook, Twitter, Google und/oder Xing und unter Umst&auml;nden auch dort gespeichert. N&auml;heres erfahren Sie durch einen Klick auf das <em>i</em>.',
        ...
        return this.each(function () {
            ...
            if (facebook_on) {
                ...
                context.append('<li class="facebook help_info"><span class="info">' + options.services.facebook.txt_info + '</span><span class="switch off">' + options.services.facebook.txt_facebook_off + '</span><div class="fb_like dummy_btn">' + fb_dummy_btn + '</div></li>');
                ...
                $('li.facebook div.fb_like img.fb_like_privacy_dummy,li.facebook span.switch', context).live('click', function () {
                    if ($container_fb.find('span.switch').hasClass('off')) {
                        ...
                        $container_fb.find('span.switch').addClass('on').removeClass('off').html(options.services.facebook.txt_facebook_on);
                        $container_fb.find('img.fb_like_privacy_dummy').replaceWith(fb_code);
                    } else {
                        $container_fb.removeClass('info_off');
                        $container_fb.find('span.switch').addClass('off').removeClass('on').html(options.services.facebook.txt_facebook_off);
...
//                var xing_enc_uri = encodeURIComponent(uri + options.services.xing.referrer_track);
                ...
                var xing_code = '<script data-url="' + xing_uri + '" data-lang="' + options.services.xing.language + '" data-counter="right" type="XING/Share"></script><script>;(function(d, s) {var x = d.createElement(s),s = d.getElementsByTagName(s)[0];x.src ="https://www.xing-share.com/js/external/share.js";s.parentNode.insertBefore(x, s); })(document, "script");</script>';
                var xing_dummy_btn = '<img src="' + options.services.xing.dummy_img + '" alt="XING &quot;Share&quot;-Dummy" class="xing_dummy" />';

                context.append('<li class="xing help_info"><span class="info">' + options.services.xing.txt_info + '</span><span class="switch off">' + options.services.xing.txt_xing_off + '</span><div class="xing dummy_btn">' + xing_dummy_btn + '</div></li>');

                var $container_xing = $('li.xing', context);

                $('li.xing div.xing img,li.xing span.switch', context).live('click', function () {
